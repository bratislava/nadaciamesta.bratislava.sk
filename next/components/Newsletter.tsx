...
const Newsletter = ({ text }: INewsletterProps) => {
  ...
  return (
    <div className="container mx-auto w-full flex flex-col md:flex-row gap-8 justify-between items-center">
      ...
      <div
        className={cx('flex items-center justify-center fixed top-0 right-0 bottom-0 left-0', {
      ...
      >
        ...
        <div className="grid relative z-10 gap-8 m-8z bg-font text-white px-8 py-12 md:px-24 md:py-24">
          <Button className="absolute right-5 top-5 border-none px-2 py-2" onClick={() => setModalOpened(false)}>
            <CancelIcon stroke="var(--secondary-color)" />
          </Button>
          <div className="text-center text-xl lg:text-2xl font-bold">Prihlásenie sa na odber noviniek</div>
          ...
          <div>
            ...
            />
            {acquaintanceError && <div className="text-error ml-14">{acquaintanceError}</div>}
          </div>
