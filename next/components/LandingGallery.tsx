...
const LandingGallery = ({ slidesTop, slidesBottom }: ILandingGalleryProps) => {
  ...
  return (
    <div className="flex flex-col self-stretch bg-white">
      <div className="flex justify-center" style={{ height: 390, paddingTop: 0 }}>
        <LandingSwiper numOfSlides={numTopSlides} speed={17_000} slides={slidesTop} />
      </div>
      <div className="flex min-w-full justify-center" style={{ height: 390 }}>
        <LandingSwiper numOfSlides={numBottomSlides} speed={19_000} slides={slidesBottom} />
      </div>
    </div>
  )
}
